...
int main(int argc, char* argv[]) {
    ...
    case 2:
        ...
        break;
    default:
        csvPath = "eBid_Monthly_Sales.csv";     //_Dec_2016 for this one
    }
    ...
    while (choice != 9) {
        ...
        case 3:
            ...
            selectionSort(bids);
            ticks = clock() - ticks;
            cout << "Selection Sort: " << ticks << " clock ticks" << endl;
            cout << "Selection Sort: " << ticks * 1.0 / CLOCKS_PER_SEC << " seconds" << endl;
            break;
        ...
        case 4:
            ...
            ticks = clock() - ticks;
            cout << "Quick Sort: " << ticks << " clock ticks" << endl;
            cout << "Quick Sort: " << ticks * 1.0 / CLOCKS_PER_SEC << " seconds" << endl;
            break;
        }
    }
